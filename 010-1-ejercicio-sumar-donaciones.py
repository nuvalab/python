...
# for i in donations.values(): #Al poner el metodo ".values", le estamos indicando al BUCLE FOR, que recorra los valores del diccionario llamado "donations"
#     total_donations += i # El "+=" se conoce como un operador de asignación y lo que indica es: "total_donations = total_donations + i". Entonces en cada iteración se ira sumando a  la variable "total_donations" lo que valga "i"
