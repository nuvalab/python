...
print(my_string2.find('iti')) #Cuando no encuentra el caracter o cadena indicada el resultado sera siempre "-1"
print(my_string2.find('p', 33)) #Aqui le estamos indicando que nos busque la letra "p" despues del indice numero 33
