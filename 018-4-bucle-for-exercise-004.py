...
for i in range(1,21):
    if i == 7 or i == 13: #Aqui tuve que poner esta condicion de primera dado que si la ponia de ultimas la primera condicion que coincide va a imprimirse... 
        #En este caso el 7 y el 13 son numeros IMPARES entonces si la condicion que evalua los impares esta de primera, se va a imprimir que son IMPARES, pero no que son numeros SUPER SUERTUDOS 
