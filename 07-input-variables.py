...
number=input('Enter the first number:') #Si declaramos esta variable de esta forma, no importa el tipo de valor que pongamos, el sistema lo interpretara como un "string"
print(f'The data type of the variable "number" is: {type(number)}')
