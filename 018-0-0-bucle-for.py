...
#Tener en cuenta que aqui tambien podemos hacer uso de la funcion "range la cual veremos mas en profundidad un poco mas adelante", entonces un ejemplo simple seria algo como:
