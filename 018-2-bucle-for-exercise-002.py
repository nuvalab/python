...
Pro si queremos mostrar tanto el key como el value: my_dic_1.items()
...
#Si quisieramos imprimirlo como enteros podriamos hacerlo de la forma que ya habiamos visto
